...
function TabsTab({
   ...
   return (
      <TabsPrimitive.Tab
         className={cn(
            "inline-flex h-8 cursor-(--cursor) items-center justify-center rounded-full px-2.5 aria-selected:bg-gray-12 aria-selected:text-gray-1 dark:aria-selected:bg-gray-4 dark:aria-selected:text-gray-12",
