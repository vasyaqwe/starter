...
export const dialogStyles = {
   ...
   popup: "-mt-8 -translate-x-1/2 -translate-y-1/2 fixed top-1/2 left-1/2 w-96 max-w-[calc(100vw-3rem)] rounded-xl bg-primary-2 p-4 shadow-sm dark:shadow-xl shadow-black/15 dark:shadow-black outline outline-transparent dark:outline-primary-5",
   backdrop:
...
export const popupStyles = {
   ...
   base: "rounded-xl bg-primary-12 text-white shadow-md outline-1 outline-transparent outline-offset-0 dark:bg-primary-3 dark:shadow-lg dark:outline-primary-6",
   separator:
