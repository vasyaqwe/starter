...
export const dialogStyles = {
   ...
   popup: "-mt-8 -translate-x-1/2 -translate-y-1/2 fixed top-1/2 left-1/2 w-96 max-w-[calc(100vw-3rem)] rounded-xl bg-primary-2 p-4 shadow-lg outline outline-transparent dark:outline-primary-5",
   backdrop:
   ...
   title: "-mt-1.5 mb-1.5 font-semibold text-lg",
